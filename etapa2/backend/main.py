...
def make_predictions(dataElements: List[DataModel]):
   ...
   for dataModel in dataElements:
      ...
      try:
         ...
         pass
      valor_retorno.append({"prediction": respuesta, "probabilities": respuesta_proba})
...
def modificacion_palabras(resultado):
   ...
   for i, coefs in enumerate(coeficientes):
      ...
      top_features = model['LogisticRegression'].grid_search.best_estimator_.feature_names_in_[top_indices]
